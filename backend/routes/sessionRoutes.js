...
const { upload, sendSessionRequest, acceptSessionRequest, rejectSessionRequest, getPendingSessions, getAcceptedSessions, getCompletedSessions, getCanceledSessions, sendMessage, getMessages, scheduleSession, markSessionAsCompletedOrCanceled, getUserAverageRating, getOnlyAcceptedSessions } = require('../controllers/sessionController');
...
router.post("/reject", verifyToken, rejectSessionRequest);
